/**
 * This class handles hazardous waste collection.
...
public class HazardousCollection implements CollectionChain {
     ...
     * If the container has hazardous waste, this handler processes it.
     * Otherwise, it passes the request to the next handler.
     */
    @Override
    public void collect(WasteContainer container) {
        if (container.getType().equals("hazardous")) {
            System.out.println("Collecting hazardous waste from " + container.getLocation());
            System.out.println("Capacity: " + container.getCapacity());
            System.out.println("WARNING: Special safety procedures required!");
            System.out.println("Processing for safe disposal...");
        } else {
